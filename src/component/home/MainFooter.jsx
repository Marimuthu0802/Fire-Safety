...
const MainFooter = () => {
  return (
    <footer className="bg-[url('./src/assets/footer.png')] bg-cover bg-center bg-no-repeat text-white py-10 px-4">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
        
        {/* Logo and Info */}
        <div className="space-y-4">
          <img src="./src/assets/logo.png" alt="LOGO" width={100} className="object-contain" />
