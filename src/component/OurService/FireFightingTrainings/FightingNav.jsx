...
const FightingNav = () => {
  return (
    <div>
      ...
      <h1 className="text-4xl font-semibold mb-6">Fire Fighting Training</h1>
      <p className='bg-gray-700 inline-block lg:w-92 px-8 py-4 mx-auto'>BTSafe - Fire Fighting Training</p>
    </div>
